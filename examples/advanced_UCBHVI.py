...
def main():
    ...
    kernels = [gpflow.kernels.RBF(lengthscales = 0.75, variance = 0.5) for i in [0,1]]
    ...
    #acq = infill.UHVI(beta = 0.01,use_bi = True)
    ...
    #plotting.plot_full(mobo_opt, f, n = 50)
    plotting.plot_acq(mobo_opt, n = 50)
