...
"""raw_gaussian_process

This module contains a raw implimentation of the 
Gaussian Process method of fitting w/o the use of external libraries

It also includes an implimentation of an Anisotropic kernel, which
can be used to incorperate physics knoweledge/old data to inform a more
accurate kernel which results in more accurate predictions from the 
Gaussian Process.
